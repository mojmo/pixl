 ...
 * 
 * Endpoints:
 * - GET    /api/v1/artworks?type=public&page=1&limit=10 - Get public artworks
 * - GET    /api/v1/artworks/{id} - Get artwork by ID
 * - GET    /api/v1/artworks/user/{userId|me} - Get user's artworks
 * - GET    /api/v1/artworks/share/{link} - Get artwork by shareable link
 ...
 * @since 1.0
 */
@WebServlet("/api/v1/artworks/*")
public class ArtworkServlet extends BaseServlet {

    private static final String COMPONENT_NAME = "ArtworkServlet[v1]";
    ...
    public void init() throws ServletException {
        ...
        LogUtil.logInfo(COMPONENT_NAME, "init", "ArtworkServlet v1 initialized successfully");
    }
